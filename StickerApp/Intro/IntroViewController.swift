...
class IntroViewController: UIViewController {
    ...
    func setupIntro1() {
        ...
        widthButtonConstraint.constant = view4.bounds.width * 0.3
    }
    func setupIntro2() {
        ...
        widthButtonConstraint.constant = view4.bounds.width * 2/3
    }
    func setupIntro3() {
        ...
        widthButtonConstraint.constant = view4.bounds.width
    }
}
